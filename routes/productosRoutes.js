...
const validarProducto = require('../middlewares/validaciones').validarProducto; // Ajusta import si necesario
const autenticarToken = require('../middlewares/authMiddleware');
const mongoose = require('mongoose');

// Listar productos con búsqueda insensible a mayúsculas/minúsculas
